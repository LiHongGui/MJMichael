...
typedef enum {
    ...
    deviceFive_five = 3,
    deviceFive_eight = 4,
    deviceSix_one = 5,//deviceSix_five = 6,
    deviceSeven_nine = 6,
    deviceNine_Seven = 7,
    deviceTen_five = 8,
    deviceEleven = 9,
    deviceTwelve_nine = 10,
} deviceType;
typedef void (^MJDeviceBlockWH)(NSString *wh);
typedef void (^MJDeviceBlockType)(NSInteger deviceType);
@interface MJDevice : NSObject
@property(nonatomic,copy) MJDeviceBlockWH widthHeight;
@property(nonatomic,copy) MJDeviceBlockType deviceType;
...
//@end
@interface MJDocumentPicker :NSObject
typedef void (^MJDocumentPickerBlock)(NSString *fileName,NSURL *fileURL, NSData *fileData);
@property(nonatomic,strong) UIDocumentPickerViewController *documentPickerVC;
+ (MJDocumentPicker *)shareManager;
@property(nonatomic,strong) NSString *pageId;
@property(nonatomic,copy) MJDocumentPickerBlock
returnValueBlock;
@end
...
typedef void (^TimeOutBlock)(BOOL timeOutBooL);
...
//+(void)saveLaunchImage:(id)launchImage value:()
